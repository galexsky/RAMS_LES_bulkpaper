...
#LIBS=-L/usr/lib/x86_64-linux-gnu -lrt -L/nasa/szip/2.1.1/lib
...
#############################################################################
C_COMP=icc
C_OPTS=-O3 -DUNDERSCORE -DLITTLE -std=c99 -lmpi
