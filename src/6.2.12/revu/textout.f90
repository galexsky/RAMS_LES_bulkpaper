...
if(len_trim(cvar).eq.7 .and.cvar(1:7) .eq.'r_total')                 ngem='MIXS'
if(len_trim(cvar).eq.11.and.cvar(1:11).eq.'rtotal_orig')             ngem='MIXT'
...
!3D MICROPHYSICAL TOTAL BUDGETS - 55 variables
