...
CALL therm_bcond (mzp,mxp,myp,basic_g(ngrid),ibcon)
...
!##############################################################################
Subroutine therm_bcond (m1,m2,m3,basic,ibcon)
...
!Do not do top and bottom boundary settings here since
!theta and rv are diagnosed and updated in rthrm.f90
